# Calibracao — registro mecanico de sinais (atualizado 2026-09-14 11:05 BRT)
...
| Descartados por R:R baixo | 48 | 46 | 33 (72%) | +6.65R (+0.145R/sinal) |
| TODOS | 80 | 77 | 37 (48%) | -11.27R (-0.146R/sinal) |

**MAE dos acertos** (quanto o preco foi CONTRA antes de dar certo) — n=37, mediana 0.38R, maximo 0.98R, 14% acima de 0.8R.

> Le-se assim: apertar `STOP_BUFFER_ATR_MULT` mata os acertos cujo MAE ja esta perto de 1R. Se essa cauda for gorda, nao ha folga pra apertar o stop.

**MFE dos erros** (quanto o preco foi A FAVOR antes de bater stop) — n=40, mediana 0.36R, 25% chegaram a 1R a favor.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| BTC/USDT | B | compra | nao | proximo | 0.26 | 0.26 | aberto | — | — | — | 2026-09-14 11:05 |
