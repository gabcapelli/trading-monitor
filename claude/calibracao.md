# Calibracao — registro mecanico de sinais (atualizado 2026-09-25 12:05 BRT)
...
| Descartados por R:R baixo | 148 | 146 | 90 (62%) | -9.28R (-0.064R/sinal) |
| TODOS | 204 | 202 | 100 (50%) | -30.81R (-0.153R/sinal) |
...
**MFE dos erros** (quanto o preco foi A FAVOR antes de bater stop) — n=102, mediana 0.36R, 24% chegaram a 1R a favor.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| XRP/USDT | A | compra | nao | proximo | 2.49 | 0.34 | aberto | — | — | — | 2026-09-25 12:05 |
