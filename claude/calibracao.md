# Calibracao — registro mecanico de sinais (atualizado 2026-09-25 19:05 BRT)
...
| Descartados por R:R baixo | 150 | 148 | 90 (61%) | -11.28R (-0.076R/sinal) |
| TODOS | 206 | 204 | 100 (49%) | -32.81R (-0.161R/sinal) |
...
**MFE dos erros** (quanto o preco foi A FAVOR antes de bater stop) — n=104, mediana 0.36R, 23% chegaram a 1R a favor.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| WLD/USDT | B | venda | nao | proximo | 2.00 | 1.63 | aberto | — | — | — | 2026-09-25 19:05 |
