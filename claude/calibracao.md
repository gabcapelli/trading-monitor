# Calibracao — registro mecanico de sinais (atualizado 2026-09-25 18:05 BRT)
...
| Descartados por R:R baixo | 149 | 147 | 90 (61%) | -10.28R (-0.070R/sinal) |
| TODOS | 205 | 203 | 100 (49%) | -31.81R (-0.157R/sinal) |
...
**MFE dos erros** (quanto o preco foi A FAVOR antes de bater stop) — n=103, mediana 0.36R, 23% chegaram a 1R a favor.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| DOGE/USDT | B | compra | nao | proximo | 1.21 | 1.21 | aberto | 0.437 | 0.655 | — | 2026-09-25 17:05 |
